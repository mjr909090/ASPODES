...
auditAssignBookApp.controller('ngAuditAssignBookCtrl', ['$scope', '$http', '$downloadFile', function ($scope, $http, $downloadFile) {
    var assignBookUrl = "/api/annualTask/instAdmin/review";//Get获取列表
    var leaderInfoUrl = "/api/person/";//Get负责人信息的Url

    var reviewAssignBookUrl = "/api/annualTask/instReview/"; //put pass=true提交任务书;false驳回
