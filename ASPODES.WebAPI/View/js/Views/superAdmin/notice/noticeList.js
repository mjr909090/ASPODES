...
var noticeList = angular.module('ngNoticeListApp', ["ngFileUpload", "ngCookies"]);

noticeList.controller('ngNoticeListCtrl', function ($scope, $http, Upload, $timeout, $cookies) {
    //url
    var getNoticeUrl = "/api/Announcement/depart/";//院管理员获取公告 api/Announcement/depart/{page}

    var addNoticeUrl = "/api/Announcement/depart/"//院管理员添加公告 post
    var editNoticeUrl = "/api/Announcement/depart";//院管理员编辑公告信息 put
    var deleteNoticeUrl = "/api/Announcement/depart/";       //院管理员删除公告
